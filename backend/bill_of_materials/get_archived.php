...
$query = "
    ...
    WHERE 
        (d.ROW_TYPE = 0 AND p.DELETE_STATUS = 1)
    OR (d.ROW_TYPE = 1 AND m.DELETE_STATUS = 1)
    OR (d.ROW_TYPE = 0 AND p.DELETE_STATUS = 0 AND p.PART_SURROGATE IN (SELECT PART_SURROGATE FROM DeletedChildren))
